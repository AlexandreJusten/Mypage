// import { Card, CardBody, CardFooter, Grid, Grommet, Heading, Text } from "grommet";
// import { Code, Server, Html5, Java,  Node, Database, Reactjs,  Css3, PhoneVertical } from "grommet-icons";
...
// // Mapeando as tecnologias para seus ícones
// const data = [
//   { 
//     title: 'Sobre',
...
//     technologies: [
//       { name: 'HTML', icon: <Html5 size="large" color="brand" /> },
//       { name: 'CSS', icon: <Css3 size="large" color="brand" /> },
//       { name: 'JavaScript', icon: <Code size="large" color="brand" /> },
//       { name: 'ReactJS', icon: <Reactjs size="large" color="brand" /> },
//       // { name: 'VueJS', icon: <Vuejs size="large" color="brand" /> },
//       { name: 'ReactNative', icon: <PhoneVertical size="large" color="brand" /> },
//       { name: 'Java', icon: <Java size="large" color="brand" /> },
//       // { name: 'Python', icon: <Python size="large" color="brand" /> },
//       { name: 'Node.js', icon: <Node size="large" color="brand" /> },
//       { name: 'Spring Boot', icon: <Server size="large" color="brand" /> },
//       { name: 'Django', icon: <Server size="large" color="brand" /> },
//       { name: 'Express', icon: <Server size="large" color="brand" /> },
//       { name: 'MySQL', icon: <Database size="large" color="brand" /> },
//       { name: 'PostgreSQL', icon: <Database size="large" color="brand" /> },
//     ]
//   },
// ];
...
//       <Grid pad="large" columns={['40%', '40%']} justifyContent="center" gap="medium">
